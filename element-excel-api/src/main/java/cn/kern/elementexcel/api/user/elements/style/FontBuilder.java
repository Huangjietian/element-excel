...
public class FontBuilder {
    ...
    public static Font applyFont(Workbook workbook, cn.kern.elementexcel.api.user.elements.style.Font font) {
        return applyFont(workbook.createFont(), font);
    }

    public static Font applyFont(Font targetFont, cn.kern.elementexcel.api.user.elements.style.Font font) {
        return newInstance(targetFont)
